                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Qualified Car PPF
                                        Service </h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-primary">Car clinic by G.R</span> Is The Best Place For Your Auto Care
                    </h1>
                    <p class="mb-4">Car Clinic by G.R is the ultimate destination for expert auto care, offering reliable service with modern equipment and skilled professionals.</p>
                        ...
                        <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Highly trained and experienced individuals committed to excellence and professional integrity.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>A trusted servicing center delivering top-notch quality, reliability, and customer satisfaction.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                            <div class="d-flex">
                                ...
                                <div class="ps-3">
                                    ...
                                    <span>Award-winning workers celebrated for excellence, skill, and outstanding performance.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="/about" class="btn btn-primary py-3 px-5 mt-5">Read More<i
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Car Clinic by GR, Walayat Colony, Rawalpindi, 46000</p>
